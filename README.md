# Voice-Control With the ESP32

Build your own voice-control system - all you will need is an ESP32 and Microphone board .


I'm using a microphone breakout board that I've built myself based around the INMP441 - but any microphone board will work.
